...
revision surface and preservation rules.
...
rendered text. Invalid output continues to preserve raw agent output for
inspection and exits nonzero without emitting an applied-change summary.
