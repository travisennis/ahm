...
If `ahm` is unavailable, read the generated task index at `.agents/.tasks/index.md` as
the fallback queue artifact and inspect the relevant files under the active
task bucket.
